...
In 1992 the outstanding [Ward Cunningham](https://en.wikipedia.org/wiki/Ward_Cunningham) used the analogy of a financial [debt](http://c2.com/doc/oopsla92.html) to refer to that **"not-quite-right-code"** (you can see [his 5' video](https://www.youtube.com/watch?v=pqeJFYwnkjE) too)
...
3. Making a client owe money feels WRONG
4. We shouldn’t be leaking our client’s pocket
5. Hiding a small money leak is easy until it isn’t, but it might be somebody else's problem by then. (pass–the–buck factor)
...
As in every industry, minimizing waste production during manufacturing is a game changer. The prevention principle is **interrelated** with the [Execution](#execution) area of the life-cycle.
...
- Tech-debt is not a bad thing "per se", **the bad thing is the "un" factor**
  ...
  - Un-planned
  - Un-handled
- **Bug fixing and security are commonly related to tech-debt** but that's **not a ["sine qua non"](https://en.wikipedia.org/wiki/Sine_qua_non) condition**. Having separated backlogs or tags for bug fixing, security and technical debt is a good idea and the more data-oriented and granular the backlog is, the easier to analyzing the data will be.
